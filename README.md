...
Si ejecutas el archivo `seed.py`, el sistema generará automáticamente los siguientes usuarios para que pruebes los diferentes roles (la contraseña para todos es **`12345`**):
